...
Build SA-BDD from the source and intsall dependencies:
...
Sa-bdd uses the {__test_framework__} test framework. Run the test suite with:
...
Sa-bdd is protected under the [LICENSE](https://choosealicense.com/licenses) License. For more details, refer to the [LICENSE](https://choosealicense.com/licenses/) file.
